...
/**
 * Tensors' writer for a field that allows additional indexing logic to be implemented by the caller
 *
 * @lucene.experimental
 */
public abstract class FlatTensorsWriter extends FlatVectorsWriter {
  /** Scorer for flat tensors */
  protected final FlatTensorsScorer tensorScorer;

  /** Sole constructor */
  protected FlatTensorsWriter(FlatTensorsScorer tensorScorer) {
    super(null);
    this.tensorScorer = tensorScorer;
  }

  public FlatVectorsScorer getFlatVectorScorer() {
    throw new UnsupportedOperationException("Tensor writer does not work on vector scorer");
  }
